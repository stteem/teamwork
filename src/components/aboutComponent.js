        ...
        <div className="container">
            ...
            <div className="row row-content">
                <div className="col-12 col-md-10">
                    ...
                    <p>TeamWork is the capstone project of the 2019 Facebook sponsored #DevCTrainingWithAndela which spanned 3 months, starting September 2019 till 30th November 2019, 
                    ...
                    <li> Apparently, most of the spec shortcomings were with the response data required, when it wasn't with the API itself. For the feed API, following the database design
                    which required seperate image and article tables, one must pull off some SQL query that leaves one panting for breath, whilst rendering the query non performant if scaled up.
                    Let's see how that went for me.
                       
                    <p>
                    <sub>
                        const deftQuery =   `WITH A as (SELECT i.imageid as itemid, i.createdon, i.title, i.imageurl as item, i.userid, u.firstname as author 
                    ...
                    <h5>Issues</h5>
                    <p>
                    Since i have been dragging the project spec, i thought i should wash my dirty linen in public as well, before you go find out how inept i have been with some of those endpoints. 
                    Even though i have created and consumed all required endpoints, the project is not completely production ready. But after reading @unicodeveloper article titled 
                    "Who is Speaking On Your Behalf? by Prosper Otemuyiwa", i thought it was time to let the world in on my awesome coding prowess:) So as you see how i am saving the third realm 
                    ...
                    <li>
                    Validations and Alerts. Javascript Fetch API lets you return custom error messages, but has no seamless way of getting server response, i stand to be corrected on this assertion though. So until i find my way, 
                    ...
                    and not worried about losing unfinished posts. On becoming a develper, i was and stil am, unrepentant about building great UX. Only the create-user route has that implementation for now. You may experiment with it,
                    as you will see, the submit button is disabled as only "isadmin = true" has the right to create a new user.
                    </li>
                    <li>
                    For the "update and delete" endpoints, setting up the menu options with Material UI components was a first for me, and memorable because it led me to finally learn react hooks, making functional components the more useful.
                    ...
                    <ul>
                    <li>Email: ubo@gmail.com</li>
                    <li>Password: password</li>
                    </ul>
                    <h5>Login Detail 2</h5>
                    <ul>
                    <li>Email: ekon@gmail.com</li>
                    <li>Password: password</li>
                    </ul>
